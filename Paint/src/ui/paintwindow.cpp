...
PaintWindow::PaintWindow(QWidget *parent) : QMainWindow(parent, Qt::FramelessWindowHint | Qt::WindowSystemMenuHint),
...
void PaintWindow::on_tableBtn_clicked()
{
    ...
    if (ui->tableCont->geometry() == QRect(1220, 149, 321, 571))
    { // Check table Pos
...
void PaintWindow::on_logoBtn_clicked()
{
    ...
    if (ui->menu->geometry() == QRect(50, 69, 121, 111))
    { // Check table Pos
        // if table is viewed out the view
