...
void drawScene()
{
	...
	glColor3f(1.0f, 1.0f, 1.0f);
	drawText(timeText, -0.26f, -0.03f, 0.0f);
...
int main(int argc, char** argv)
{
	...
	glutCreateWindow("OpenGL Analog Clock With Routating Digital Time Display");
